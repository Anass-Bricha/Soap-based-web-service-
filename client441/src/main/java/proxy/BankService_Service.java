 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:9191/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("http://ws/", "BankService");
